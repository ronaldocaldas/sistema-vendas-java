...
public class VendaTest extends TestHeranca{
	...
	@Before
	public void setup(){
		 c1 = new Cliente("34125365474", "teste1@mail", "Rua 1", "Cliente 1", new Date(), 2000);
		 c2 = new Cliente("34125365474", "teste2@mail", "Rua 2", "Cliente 2", new Date(), 3000);
		 c3 = new Cliente("34125365474", "teste3@mail", "Rua 3", "Cliente 3", new Date(), 4000);
